import { describe, expect } from "./test-deps.ts";
import {
  has,
  optional,
  parse,
...
describe("natural date parser", () => {
  ...
  const weekdayChoices = Object.freeze(
    [
      "monday",
      "tuesday",
      "wednesday",
  ...
  function* NaturalDateParser(): ParseGenerator<Result> {
    ...
    return {
      repeats: repeats ? "weekly" : undefined,
      weekdays,
      ...(timespan as any),
    };
  }
  ...
  Deno.test.each([
    ...
    ["Wednesday and Saturday", {
      weekdays: new Set(["wednesday", "saturday"]),
    }],
    ...
    ["Wednesdays and Tuesdays", {
      repeats: "weekly",
      weekdays: new Set(["wednesday", "tuesday"]),
    }],
    [" Wednesdays and Tuesdays ", {
      repeats: "weekly",
      weekdays: new Set(["wednesday", "tuesday"]),
    }],
    ["Wednesdays and Tuesdays and Fridays and Wednesdays", {
      repeats: "weekly",
      weekdays: new Set(["wednesday", "tuesday", "friday"]),
    }],
    ["Wednesdays at 9", {
      repeats: "weekly",
      weekdays: new Set(["wednesday"]),
    ...
    ["Mondays and Thursdays at 9:30 to 10:30", {
      repeats: "weekly",
      weekdays: new Set(["monday", "thursday"]),
      startTime: { hours: 9, minutes: 30 },
      endTime: { hours: 10, minutes: 30 },
    }],
    ["Mondays at 9:30pm to 10:30pm", {
      repeats: "weekly",
      weekdays: new Set(["monday"]),
      startTime: { hours: 21, minutes: 30 },
      endTime: { hours: 22, minutes: 30 },
    }],
    ["Fridays from 11:15am to 12:30pm", {
      repeats: "weekly",
      weekdays: new Set(["friday"]),
      startTime: { hours: 11, minutes: 15 },
      endTime: { hours: 12, minutes: 30 },
    }],
    ["Fridays from 11:15am to 12:00am", {
      repeats: "weekly",
      weekdays: new Set(["friday"]),
      startTime: { hours: 11, minutes: 15 },
